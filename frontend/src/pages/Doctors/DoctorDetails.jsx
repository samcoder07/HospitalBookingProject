						...
						<div className="flex items-center gap-5">
							...
							leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>
								...
								<div className="flex items-center gap-[6px]">
									<span className='flex items-center gap-[6px] text-[14px] leading-5 lg:text-[16px] lg:leadig-7 font-semibold text-headingColor'>
										<img src={starIcon} alt="" /> 4.8
									</span>
									<span className='text-[14px] leading-5 lg:text-[16px] lg:leadig-7 font-[400] text-textColor'>(272)</span>
								</div>
								<p className='text__para text-[14px] leading-5 md:text-[15px] lg:max-w-[390px]'>
									Lorem ipsum dolor, sit amet consectetur adipisicing elit. Accusantium, iure perspiciatis quis vero animi dolor.
								</p>
							</div>
						</div>
