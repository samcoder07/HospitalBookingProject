					...
					<div className=" flex flex-col lg:flex-row gap-[90px] item-center justify-between">
						...
						<div>
							<div className='lg:w-[570px]'>
								...
								<p className='text__para'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Veritatis, laboriosam. Non laborum inventore veniam doloremque eaque ut impedit aut deserunt.</p>
						...
						{/* hero content  */}
						<div className='flex gap-[30px] jutify-end'>
							<div>
						...
						<div className='py-[30px] px-5'>
							...
							<div className="mt-[30px]">
								...
								<p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
									World-class care for everyone. Our health System to offers unmatches, expert health care. From the lab to the clinic.
								</p>
					...
					<div className="flex items-center justify-between flex-col lg:flex-row">
						...
						<div className="relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0">
							...
							<div className="w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]">
								...
								<div className="w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px] lg:px-[10px]text-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] mt-2 lg:mt-4">
									Consultation
								</div>

								<div className="flex items-end gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]">
