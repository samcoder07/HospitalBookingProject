	...
	return (
		<div className='mt-10'>
			<form onSubmit={submitHandler} method="post">
				...
				<div className="mb-5">
					<input type="password" name="password" id="password" placeholder='Enter Password...' value={formData.password} onChange={handleInputChange} className='w-full pr-4 py-3  border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[22px] leading-7 text-hradingColor placeholder:text-textColor cursor-pointer' />
				</div>
				<div className="mb-5">
